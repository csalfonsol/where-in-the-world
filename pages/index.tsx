...
const Home: NextPage<{ countries: CountryData[] }> = ({ countries }) => {
  ...
  const filteredCountries =
    regionFilter === "" ? countries : countries.filter(country => country.region.toLowerCase() === regionFilter);

  const searchedCountries =
    searchQuery === "" ? filteredCountries : filteredCountries.filter(country =>
  ...
  const countryList = searchedCountries.map(country => (
